<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="View_Banner.aspx.cs" Inherits="Administrator_View_Customer" %>
        ...
        <div class="container-fluid">
            <div class="row mb-2 justify-content-between">
                ...
                <div class="col-sm-2 float-sm-right">
                    <asp:HyperLink ID="hlAddBanner" runat="server" class="btn btn-sm bg-gradient-dark pt-2 float-right" NavigateUrl="~/Administrator/AddBanner.aspx">+Add</asp:HyperLink>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                <div class="">
                                                    <asp:GridView ID="gvBanner" runat="server" CssClass="tables display dataTable w-100 basic-datatable table-bordered orderTable "
                                                        ...
                                                        DataKeyNames="Sr_No" OnRowCommand="gvBanner_RowCommand" OnRowCreated="gvBanner_RowCreated" OnRowDataBound="gvBanner_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Photo">
                                                                <ItemTemplate>
                                                                    <a href='../Attachment/BannerPromoImg/<%# Eval("Image")%>' target="_blank">
                                                                        <img src='../Attachment/BannerPromoImg/<%# Eval("Image")%>' style="font-size: x-small; width: 50px; height: 50px" />
                                                                    </a>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Is Redirect">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblIsRedirect" runat="server" Text='<%# Eval("Is_Redirect")%>' class="f-12"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Url">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblUrl" runat="server" Text='<%# Eval("Url") %>' class="f-12"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li style="font-size: 17px;">
                                                                                    <asp:LinkButton ID="LinkButtonsummery" runat="server" CssClass=" p-2" CommandArgument='<%# Eval("Sr_No")%>' CommandName="BannerEdit" CausesValidation="false" Style="font-size: 17px; color: Black;">          
                                                                                <i class="fa-solid fa-edit"></i> Edit</asp:LinkButton>
                                                                                </li>
                                                                                <li style="font-size: 17px;" runat="server" id="liDelete">
                                                                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass=" p-2" OnClientClick="return confirm('Do you want to delete this Banner ?');" CommandArgument='<%# Eval("Sr_No")%>' CommandName="DeletBanner" CausesValidation="false" Style="font-size: 17px; color: red;">          
