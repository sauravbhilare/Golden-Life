<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="View_Folders.aspx.cs" Inherits="Administrator_View_Customer" %>
        ...
        <div class="container-fluid">
            <div class="row mb-2 justify-content-between">
                ...
                <div class="col-sm-2 float-sm-right">
                    <asp:LinkButton ID="hlAddFolder" runat="server" class="btn btn-sm bg-gradient-dark pt-2 float-right" OnClick="hlAddFolder_Click" >+Add Folder</asp:LinkButton>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <div class="card-header">
                    <h3 class="card-title">Folders List</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                <div class="">
                                                    <asp:GridView ID="gvFolders" runat="server" CssClass="tables display dataTable w-100 basic-datatable table-bordered orderTable "
                                                        ...
                                                        DataKeyNames="Folder_Id" OnRowCommand="gvFolders_RowCommand" OnRowCreated="gvFolders_RowCreated" OnRowDataBound="gvFolders_RowDataBound">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Title">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblFolderName" runat="server" Text='<%# Eval("Folder_Name")%>' class="f-12"></asp:Label>
                                                                </ItemTemplate>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li style="font-size: 17px;">
                                                                                    <asp:LinkButton ID="LinkButtonsummery" runat="server" CssClass=" p-2" CommandArgument='<%# Eval("Folder_Id")%>' CommandName="gvFoldersEdit" CausesValidation="false" Style="font-size: 17px; color: Black;">          
                                                                                <i class="fa-solid fa-edit"></i> Edit</asp:LinkButton>
                                                                                </li>
                                                                                <li style="font-size: 17px;" runat="server" id="liDelete">
                                                                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass=" p-2" OnClientClick="return confirm('Do you want to delete this Reel ?');" CommandArgument='<%# Eval("Folder_Id")%>' CommandName="DeletegvFolders" CausesValidation="false" Style="font-size: 17px; color: red;">          
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <asp:Button ID="btnFolderUpate" runat="server" CssClass="btn btn-secondary" Text="Update"
                        OnClick="btnFolderUpate_Click" ValidationGroup="AddFolderGroup" />
                </div>
            </div>
        </div>
    </div>
