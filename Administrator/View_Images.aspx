<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="View_Images.aspx.cs" Inherits="Administrator_View_Customer" %>
        ...
        <div class="container-fluid">
            <div class="row mb-2 justify-content-between">
                ...
                <div class="col-sm-2 float-sm-right">
                    <asp:HyperLink ID="hlAddImages" runat="server" class="btn btn-sm bg-gradient-dark pt-2 float-right" NavigateUrl="~/Administrator/Add_Images.aspx">+Add</asp:HyperLink>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-sm-12">
                                            <div class="card-body">
                                                <div class="">
                                                    <asp:GridView ID="gvImage" runat="server" CssClass="tables display dataTable w-100 basic-datatable table-bordered orderTable "
                                                        ...
                                                        DataKeyNames="Sr_No" OnRowCommand="gvImage_RowCommand" OnRowCreated="gvImage_RowCreated" OnRowDataBound="gvImage_RowDataBound">
                                                        <Columns>
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li style="font-size: 17px;">
                                                                                    <asp:LinkButton ID="LinkButtonsummery" runat="server" CssClass=" p-2" CommandArgument='<%# Eval("Sr_No")%>' CommandName="ImageEdit" CausesValidation="false" Style="font-size: 17px; color: Black;">          
                                                                                <i class="fa-solid fa-edit"></i> Edit</asp:LinkButton>
                                                                                </li>
                                                                                <li style="font-size: 17px;" runat="server" id="liDelete">
                                                                                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass=" p-2" OnClientClick="return confirm('Do you want to delete this Image ?');" CommandArgument='<%# Eval("Sr_No")%>' CommandName="DeleteImage" CausesValidation="false" Style="font-size: 17px; color: red;">          
